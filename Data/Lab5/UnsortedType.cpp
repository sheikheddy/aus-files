 ...
 *
 *
 *The class interface, constructor and functions Length, RetrieveItem, InsertItem, and DeleteItem 
 *are taken from Dr. Ghassan Qadah's Lecture Notes 04 - ADTUnsortedList 
 *
 *
 *His style of coding is really weird. 
 *I wonder how each of his experiences have contributed to the decisions he has made.
 *
 *In some places I can definitely some influences from assembly. In others, from Java!
 * */
...
//Wow, no need to use typedefs in C++! (I have more background with C, even including CMP 120 & 220)
struct NodeType{
